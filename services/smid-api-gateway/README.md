# smid-api-gateway · SMID — API Gateway
...
| `/api/casos/**`         | `CASOS_SERVICE_URL`         | 8090   | 1           | `/casos/**`                  |
| `/api/vulneraciones/**` | `VULNERACIONES_SERVICE_URL` | 8091   | 1           | `/vulneraciones/**`          |
| `/api/productos/**`     | `PRODUCTOS_SERVICE_URL`     | 8092   | 1           | `/productos/**`              |
