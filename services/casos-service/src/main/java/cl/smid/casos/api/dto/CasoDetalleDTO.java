...
/**
 * Detalle completo de un caso: incluye el historial de transiciones y el enriquecimiento on-demand.
 * Solo identificadores opacos; nunca la PK interna.
 */
@Schema(description = "Detalle completo de un caso institucional. Expone solo identificadores opacos.")
public record CasoDetalleDTO(
        ...
        @Schema(description = "Identificador opaco del requerimiento que originó el caso.",
                example = "1e19d2cc-7c5c-4b48-9d5d-e8aef42e4f71")
        String idRequerimientoOrigen,
        @Schema(description = "Folio del requerimiento de origen.", example = "F-100")
        String folioRequerimiento,
        @Schema(description = "Estado actual del expediente.",
                example = "ABIERTO",
        ...
        Instant cerradoEn,
        @Schema(description = "Fecha de creación del registro en UTC.", example = "2027-02-01T10:00:00Z")
        Instant creadoEn,
        @Schema(description = "Fecha de última actualización en UTC.", example = "2027-02-05T12:15:00Z")
        Instant actualizadoEn,
        EnriquecimientoDTO enriquecimiento,
        @Schema(description = "Historial de materialización y transiciones del caso.")
        List<HistorialTransicionDTO> historial) {
}
