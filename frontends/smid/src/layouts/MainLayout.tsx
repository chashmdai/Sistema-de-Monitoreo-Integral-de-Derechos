        ...
        >
          ...
          <div className="hidden sm:block">
            ...
            <Text
              size="xs"
              c="dimmed"
              className="tracking-widest uppercase font-bold mt-0.5 text-[10px]"
            >
              Portal Interno
            </Text>
          </div>
        ...
        <div className="flex items-center space-x-2 sm:space-x-4">
          ...
          >
                ...
                <Group gap="sm">
                  ...
                  <div className="hidden md:block text-left">
                    ...
                    <Text
                      size="xs"
                      c="dimmed"
                      className="uppercase tracking-wider mt-1 font-semibold text-[9px]"
                    >
            ...
            <Menu.Dropdown>
              ...
              <Menu.Item
                leftSection={<Settings size={14} className="text-gray-500" />}
              >
                Configuración
              </Menu.Item>
              <Menu.Divider />
