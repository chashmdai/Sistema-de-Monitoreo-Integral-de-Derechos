...
1. **Continuidad operativa del ecosistema**
   - [`CONTINUIDAD_OPERATIVA.md`](CONTINUIDAD_OPERATIVA.md)
2. **Contexto y riesgo institucional**
...
4. **Especificacion y operacion funcional del legado**
...
6. **Evidencia tecnica complementaria**
